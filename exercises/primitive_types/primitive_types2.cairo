...
fn main() {
    ...
    let mut your_character =
        'A'; // Finish this line like the example! What's your favorite short string?
...
// Note: the following code is not part of the challenge, it's just here to make the code above
// work.
// Direct felt252 comparisons have been removed from the core library, so we need to implement them
// ourselves.
